...
export default async function PublicTournamentOverview({
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white min-h-screen border-x border-slate-100 shadow-sm">
      
      {/* Slim Brand Bar */}
      <div className="sticky top-0 z-50 w-full bg-white/95 backdrop-blur-md border-b border-slate-100 px-4 py-2.5 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h2 className="text-sm font-black text-slate-800 truncate leading-tight">{tournament.name}</h2>
      ...
      {/* Poster Banner */}
      <div className="w-full aspect-[1080/1050] relative bg-slate-900 border-b border-slate-200">
        {tournament.posterUrl ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-indigo-900 to-slate-900">
            <Trophy className="w-20 h-20 text-indigo-500/30" />
          </div>
        )}
      ...
      <div className="p-6 sm:p-8 space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="flex items-start gap-3 p-4 rounded-2xl bg-slate-50 border border-slate-100">
            ...
            <div>
              <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-0.5">Venue</p>
              <p className="text-sm font-bold text-slate-800">
